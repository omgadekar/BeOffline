...
public abstract class Hilt_VpnRecoveryReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((VpnRecoveryReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectVpnRecoveryReceiver(UnsafeCasts.<VpnRecoveryReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
